...
//                        predicates.add(criteriaBuilder.and(criteriaBuilder.or(criteriaBuilder.equal(root.get("interfaceId"),authDict.getInterfaceId()),criteriaBuilder.isNull(root.get("interfaceId")))));
                }
